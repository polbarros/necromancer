...
class Game():
    ...
    def __init__(self):
        ...
        # El canvas es un o varios objetos de la clase Surface de pygame en la que se "pintan los elementos".
        ...
        self.caption = pygame.display.set_caption("Necromancer")
        ...
        # Creamos dos variables para ver si el program está funcionando y si el jugador está jugando.
        self.running, self.playing = True, True
        # Establecemos dos variables para registrar Deltatime y el tiempo previo para independizarnos de los FPS.
        self.dt, self.prev_time = 0, 0
        # Declaramos la pila de estados. Una lista en la que se acumulan los estados (states) para manejarlos.
        self.state_stack = []
        # Iniciamos una función de esta misma clase para cargar los assets.
        self.load_assets()
        # Iniciamos una función de esta misma clase para cargar los estados.
        self.load_states()
    ...
    def game_loop(self):
        '''Esta función mantendrá un loop constante siempre que el juego funcione "self.playing == True".
        Activando y reactivando las funciones de la clase Game que mantienen el funcionamiento básico del juego:
    ...
    def get_events(self):
        ...
        # Esta función revisará los eventos a captar en le juego (inputs) mediante un bucle.
        for event in pygame.event.get():
            ...
            if self.state_stack:
                ...
                if isinstance(current_state, Combat):
                    current_state.process_gui_events(event)
                else:
        ...
        botón de forma recurrente. No será necesario establecer lógicas para el uso del teclado."""

    def update(self):
        self.state_stack[-1].update(self.dt) # "Refrescamos" el último elemento de la pila de estados.
